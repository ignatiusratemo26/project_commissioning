...
//     <>
//       {/* Hero Section */}
//       <HeroSection className='px-4 py-8 m-4'>
//         <Typography variant="h2" fontWeight="bold" gutterBottom sx={{ fontSize: { xs: '2rem', sm: '2.5rem', md: '3rem', lg: '3.5rem' } }}>
//           Welcome to NCA Project Commissioning
//         </Typography>
//         <Typography variant="h5" fontWeight="bold" gutterBottom sx={{ fontSize: { xs: '1rem', sm: '1.25rem', md: '1.5rem', lg: '1.75rem' } }}>
//           Get your project approved by NCA in no time.
//         </Typography>
//         <Button
//           variant="contained"
...
//                 <img src={card.image} alt={card.title} style={{ width: "100%", height: "100%", objectFit: "cover", transition: "transform 0.5s", "&:hover": { transform: "scale(1.05)" } }} />
//                 <Box sx={{
//                   position: "absolute",
//                   bottom: "20px",
//                   left: "20px",
